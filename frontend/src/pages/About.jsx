...
// Map skill/category names to icons
const iconMap = {
...
// Month parser for duration sorting
const monthMap = {
  Jan: 0, Feb: 1, Mar: 2, Apr: 3, May: 4, Jun: 5,
  Jul: 6, Aug: 7, Sep: 8, Oct: 9, Nov: 10, Dec: 11,
};

// Convert "Jan 2022 - Dec 2023" to a Date (end date)
...
export default function About() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Sort experiences by end date (latest first)
        ...
        // Group skills by category without duplicates
  ...
  // Define skill categories in the desired order, now including Programming Languages
