    ...
    <div className="w-full px-6 md:px-12">
      ...
      <div
        className="
          ...
          flex flex-col md:flex-row items-center gap-12 transition-transform duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/30
        "
      >
        {/* Text Content */}
        <div className="text-center md:text-left">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-6 justify-center md:justify-start">
            <button
              ...
              className="px-8 py-4 rounded-xl bg-white text-purple-700 font-semibold transition-transform duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/30"
            >
              View Resume
            </button>
            <button
            ...
            <button
              ...
              className="px-8 py-4 rounded-xl border border-white/50 text-white transition-transform duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/30"
            >
              Contact Me
            </button>
          </div>
